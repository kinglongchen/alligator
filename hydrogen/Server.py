...
class Daemon:
    ...
    def __init__(self, pidfile, stdin='log/in.log', stdout='log/out.log', stderr='log/err.log'):
        self.path = os.popen('pwd').readlines()[0].rstrip('\n')
        self.stdin = self.path+'/'+stdin
    ...
    def daemonize(self):
        ...
        # sys.stdout.flush()
        # sys.stderr.flush()
        print 'redirect standart file descriptors'
